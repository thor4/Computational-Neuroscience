...
for tN=1:trialN
    ...
    switch trialtype
        case 1 %go trial
            input=[1 0];
        case 2 %change trial
            input=[1 salience]; %low should be more of a problem, high easier
    end
...
P_Outcome = [Go_Correct./(Go_Correct+Go_Error) 1-(Go_Correct./(Go_Correct+Go_Error))... 
    Change_Correct./(Change_Correct+Change_Error) 1-(Change_Correct./(Change_Correct+Change_Error))]; %accuracy go and change trials